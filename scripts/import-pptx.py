...
MAP_DATA_FINGERPRINT_MEIO = "da71a2b6057e17c10a2e68080cd2ec23ff91b3c74c0693bc84c262a2d3fe16d4"
...
STEP_DESCRIPTIONS: dict[str, dict[str, str]] = {
    ...
    "meio": {
        ...
        "analiz-poluchennyh-znacheniy": (
            "Сценарное моделирование и интерпретация полученных значений. Типы сценариев, "
            "из которых собирается прогон: пересчёт по фильтрам (склад, канал, категория, "
            "сегмент), изменение целевого уровня сервиса, изменение политики пополнения "
            "по частоте, размеру партии и кратности, изменение лидтаймов и их отклонений, "
            "ограничение по мощностям хранения, ограничение по бюджету запаса.\n\n"
            "Перечень типов — меню, а не план прогона: за цикл считаются три сценария, "
            "выбранные из этого списка под задачу. Варианты будут уточнены по ходу "
            "проекта (сноска слайда).\n\n"
