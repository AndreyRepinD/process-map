...
MAP_DATA_FINGERPRINT_MEIO = "b1e1dfb5d720dc7d6e1066e18660a6b741fce76459958e2ae27bbca207e4aa7b"
...
STEP_DESCRIPTIONS: dict[str, dict[str, str]] = {
    ...
    "meio": {
        ...
        "nastroyka-parametrov-dlya-rascheta-urovney-zapasov": (
            ...
            "Неопределённость спроса модуль считает САМ по истории прогноза и факта; "
            "отдельного входа «ошибка прогноза из DP» не заводится — решение владельца от "
            "07.09.2026.\n\n"
            "BPMN: IO-010 — Настройка параметров для расчёта уровней запасов (IO)"
        ),
        "segmentaciya": (
